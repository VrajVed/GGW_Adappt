...
export default function PayInsights() {
  const contacts = [
    { id: 'c1', name: 'Asha Patel', upi: 'asha@upi', color: 'bg-rose-400' },
    { id: 'c2', name: 'Rohit Kumar', upi: 'rohit@upi', color: 'bg-emerald-400' },
    { id: 'c3', name: 'Nina Roy', upi: 'nina@upi', color: 'bg-indigo-400' },
  ]
  ...
  const initialHistory = [
    { id: 'h1', to: 'Grocery Store', upi: 'grocery@upi', amount: 3200, date: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000) },
    { id: 'h2', to: 'Market', upi: 'market@upi', amount: 1800, date: new Date(Date.now() - 4 * 24 * 60 * 60 * 1000) },
    { id: 'h3', to: 'Cafe', upi: 'cafe@upi', amount: 1420, date: new Date(Date.now() - 6 * 24 * 60 * 60 * 1000) },
  ]
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div>
            <div className="bg-card border border-border rounded-2xl p-6 shadow-sm">
              ...
              <div className="flex gap-3 mb-4">
                {contacts.map(c => (
                  <button
                    ...
                    className={`flex-1 text-left p-3 rounded-lg border ${selected.id === c.id ? 'border-primary bg-primary/5' : 'border-transparent hover:border-border'} transition-colors`}
                  >
              ...
              <form onSubmit={onPayClick} className="flex flex-col md:flex-row md:items-center gap-3">
                ...
                <div className="flex items-center gap-3">
                  <button
                    type="submit"
                    className="px-5 py-3 rounded-lg bg-primary text-white font-medium shadow-sm"
          ...
          <div className="space-y-6">
            <div className="bg-card border border-border rounded-2xl p-6 flex flex-col gap-4">
              <div>
                <h4 className="text-sm text-muted-foreground">Weekly Spend</h4>
                <div className="text-2xl font-semibold">₹{weeklySpend}</div>
              </div>
              <div>
                <h4 className="text-sm text-muted-foreground">Top Category</h4>
                <div className="text-lg font-medium">Groceries <span className="text-sm text-muted-foreground">32%</span></div>
              </div>
            </div>
